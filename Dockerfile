...
#    npm install -g cnpm --registry=https://registry.npm.taobao.org && ln -s /opt/nodejs/bin/cnpm /usr/local/bin && \
#    npm install -g npm@${NPM_VERSION} && \
#    npm install -g node-gyp && \
#    npm install -g fibers@${FIBERS_VERSION}

#### docker build ./ -t wekan-docker ########
...
#复制文件rajit_bootstrap3-datepicker（下载不了）
RUN mv /home/wekan/wekan-files/meteor_packages/rajit_bootstrap3-datepicker /home/wekan/.meteor/packages
...
RUN rm -f /home/wekan/app/sandstorm.js
...
# 复制文件，下载不了
RUN mkdir -p /tmp/phantomjs && chown wekan:wekan /tmp/phantomjs && mv /home/wekan/wekan-files/phantomjs-1.9.8-linux-x86_64.tar.bz2 /tmp/phantomjs
